...
;(function ($, window, document, undefined) {
  ...
  // Some users in admin were having issues accessing, basically JS failing
  // Found this line in https://ilikekillnerds.com/2014/07/foundation-v5-unrecognized-expression-syntax-namespace-fix/
  // Hope it works.
  if (Foundation.global) { Foundation.global.namespace = ''; };
