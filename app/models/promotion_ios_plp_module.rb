...
# Appears on the iOS PLP amongst products.
# Eligibility is determined by Supplier ID and wether a tag/search/category matches.

class PromotioniOSPLPModule < Promotion
